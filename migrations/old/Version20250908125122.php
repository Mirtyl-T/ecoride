 ...
 */
final class Version20250908125122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(50) NOT NULL, credits INT DEFAULT 20 NOT NULL, actif TINYINT(1) DEFAULT 1 NOT NULL, date_creation VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `vehicules` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, marque VARCHAR(50) DEFAULT NULL, modele VARCHAR(50) DEFAULT NULL, fuel_type VARCHAR(20) NOT NULL, couleur VARCHAR(50) DEFAULT NULL, immatriculation VARCHAR(255) DEFAULT NULL, date_immat DATE DEFAULT NULL, nb_places INT DEFAULT NULL, UNIQUE INDEX UNIQ_78218C2DBE73422E (immatriculation), INDEX IDX_78218C2DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
