 ...
 */
final class Version20250911163841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `trips` (id INT AUTO_INCREMENT NOT NULL, ville_depart VARCHAR(255) DEFAULT NULL, ville_arrivee VARCHAR(255) DEFAULT NULL, date_depart DATETIME DEFAULT NULL, date_arrivee DATETIME DEFAULT NULL, prix NUMERIC(5, 2) DEFAULT NULL, places_dispo INT DEFAULT NULL, status VARCHAR(20) NOT NULL, driver_id INT NOT NULL, vehicule_id INT NOT NULL, INDEX IDX_AA7370DAC3423909 (driver_id), INDEX IDX_AA7370DA4A4A3511 (vehicule_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
