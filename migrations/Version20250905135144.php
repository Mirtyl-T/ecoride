 ...
 */
final class Version20250905135144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `reviews` (id INT AUTO_INCREMENT NOT NULL, trip_id INT NOT NULL, reviewer_id INT NOT NULL, driver_id INT NOT NULL, note SMALLINT DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, valide TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_6970EB0FA5BC2E0E (trip_id), INDEX IDX_6970EB0F70574616 (reviewer_id), INDEX IDX_6970EB0FC3423909 (driver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `trips` (id INT AUTO_INCREMENT NOT NULL, driver_id INT NOT NULL, vehicule_id INT NOT NULL, ville_depart VARCHAR(255) DEFAULT NULL, ville_arrivee VARCHAR(255) DEFAULT NULL, date_depart DATETIME DEFAULT NULL, date_arrivee DATETIME DEFAULT NULL, prix NUMERIC(5, 2) DEFAULT NULL, places_dispo INT DEFAULT NULL, status ENUM(\'prévu\',\'démarré\',\'terminé\',\'annulé\'), INDEX IDX_AA7370DAC3423909 (driver_id), INDEX IDX_AA7370DA4A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(50) NOT NULL, role ENUM(\'utilisateur\',\'chauffeur\',\'passager\',\'employe\',\'admin\'), credits INT DEFAULT 20 NOT NULL, actif TINYINT(1) DEFAULT 1 NOT NULL, date_creation VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `vehicules` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, marque VARCHAR(50) DEFAULT NULL, modele VARCHAR(50) DEFAULT NULL, energie ENUM(\'essence\',\'diesel\',\'hybride\',\'electrique\'), couleur VARCHAR(50) DEFAULT NULL, immatriculation VARCHAR(255) DEFAULT NULL, date_immat DATE DEFAULT NULL, nb_places INT DEFAULT NULL, UNIQUE INDEX UNIQ_78218C2DBE73422E (immatriculation), INDEX IDX_78218C2DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `trips` ADD CONSTRAINT FK_AA7370DA4A4A3511 FOREIGN KEY (vehicule_id) REFERENCES `vehicules` (id)');
        $this->addSql('ALTER TABLE `vehicules` ADD CONSTRAINT FK_78218C2DA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `vehicules` DROP FOREIGN KEY FK_78218C2DA76ED395');
